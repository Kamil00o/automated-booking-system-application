...
public class SeatsScheme {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(planeModelName, that.planeModelName) && Objects.equals(seatsSchemeMap, that.seatsSchemeMap);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, planeModelName, seatsSchemeMap);
    }
}
